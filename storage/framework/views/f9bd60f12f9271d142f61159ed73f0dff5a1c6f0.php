        ...
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('user_profile.update', ['id' => $user->id])); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input name="introduction" type="text" class="form-control" value="<?php echo e(optional($user->userProfile)->introduction); ?>"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xs-2 col-form-label" style="color: #fff"><i class="fas fa-birthday-cake"></i> 誕生日</label>
                    <div class="col-xs-10">
                        <input name="birthday" type="date" class="form-control" value="<?php echo e(optional($user->userProfile)->birthday); ?>"/>
                    </div>
                </div>
                <div class="form-group row">
